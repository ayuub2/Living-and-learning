    ...
    return (
      <Page>
        <BasicSegment style={{position:"relative"}}>
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Enjoy yourself</h2>
        </BasicSegment>
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Cultural Southend</h2>
          ...
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Take the town trail</h2>
          ...
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Nightlife</h2>
