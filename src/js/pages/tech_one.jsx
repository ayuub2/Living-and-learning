    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          <p>Once you’re set up with an account, you can access email, log on to lab computers, connect to wi-fi and much more. If you haven’t got your login name and password yet, go to:<br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/> www.essex.ac.uk/welcome/getaccount</p>
          <p>You must change your password within four weeks of starting, and then once every four months after that. The easiest way to change your password is online at:<br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/> www.essex.ac.uk/welcome/password</p>
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Get IT help</h2>
          <p>Visit the IT Services website for helpful information, including how-to guides, answers to frequently asked questions, and links to video screencasts.<br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/> www.essex.ac.uk/welcome/it</p>
