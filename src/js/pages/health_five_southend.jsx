...
var HealthPageFiveSouthend = React.createClass({
    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          <p>If you’re studying on a course for more than six months, you’re required to register with a local doctor. You can use the NHS Choices postcode finder to find your nearest doctor.
          ...
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"health_four_southend_back")}>Back</Button>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button style={{position:"absolute", right:"0px"}} onClick={this.onClick.bind(this,"health_six_southend")}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
...
module.exports = HealthPageFiveSouthend;
