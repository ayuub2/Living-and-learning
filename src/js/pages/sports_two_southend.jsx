...
          <br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/blue/arrow.jpg"/><a href="http://www.southend-leisure.com/centre/southend-swimming-and-diving-centre/"> www.southend-leisure.com/centre/southend-swimming-and-diving-centre/</a></p>
...
          <br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/blue/arrow.jpg"/><a href="http://www.essexstudent.com/southend/societies/"> www.essexstudent.com/southend/societies/</a></p>
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"sports_southend_back")}>Back</Button>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button style={{position:"absolute", right:"0px"}}  onClick={this.onClick.bind(this,"enjoy_southend")}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
