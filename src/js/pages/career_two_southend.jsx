...
var CareerPageTwoSouthend = React.createClass({
    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/><a href="http://www.essex.ac.uk/careers/internships/default.aspx"> www.essex.ac.uk/welcome/interns</a>
          <br/><img height="13px" width="13px" src="http://www.essex.ac.uk/campusm/edits/icons/fb.jpg"/><a href="https://www.facebook.com/internshipsessex"> www.facebook.com/internshipsessex</a>
          ...
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"career_southend_back")}>Back</Button>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button style={{position:"absolute", right:"0px"}} onClick={this.onClick.bind(this,"career_three_southend")}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
...
module.exports = CareerPageTwoSouthend;
