    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          <p>Our first class Evolve Gym is designed to inspire and motivate you to keep fit. There’s a choice of annual memberships available to suit your needs and personal training is also available for an additional fee.<br/>www.essex.ac.uk/welcome/gym </p>
          <h2 style={{color:"#ff3399", fontWeight:"bold"}}>Clubs and societies</h2>
          <p>There are more than 150 sports clubs and societies for you to choose from at Essex, run by our Students’ Union. Sports clubs cover everything from football to mountaineering and our societies guild offers you a ready-made network of like- minded students. Whatever you’re into, we’re confident that there will be a society that’s perfect for you. And if there isn’t, you can set one up.<br/>www.essexstudent.com/societies</p>
          <h2 style={{color:"#ff3399", fontWeight:"bold"}}>Essex Blades for competitors</h2>
          <p>Our sports teams compete in a variety of local, regional and national competitions, including British Universities & Colleges Sport (BUCS) competitions, as well as just for fun. There are more than 50 sports clubs that are free for you to join.<br/>www.essex.ac.uk/welcome/blades</p>
