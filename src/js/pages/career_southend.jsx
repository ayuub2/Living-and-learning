...
var CareerPageSouthend = React.createClass({
    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          <p>Start preparing for your future today. No seriously. The time will fly by. We’re here to help you boost the skills and get the experience needed to make your CV shine.</p>
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Employability and Careers Centre</h2>
          <p>Our careers specialists can give you valuable advice throughout your time at Essex and beyond. We offer one-to-one individual advice and guidance, job-hunting workshops, CV and job application reviews, and online access to graduate and part-time job vacancies. Make sure you take advantage of our lunchtime workshop sessions as well as our regular drop-in clinics for on the spot advice.<br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/><a href="http://www.essex.ac.uk/careers/"> www.essex.ac.uk/welcome/careers</a></p>
...
module.exports = CareerPageSouthend;
