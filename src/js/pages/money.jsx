...
var MoneyPage = React.createClass({
    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <p>Getting a huge wad of cash in your bank account at the start of the year isn’t the easiest way to plan out your finances for the months ahead. The National Union of Students advises that you plan your budget very carefully. Make sure you remember all your outgoings and be realistic – include:<br/>rent<br/>food<br/>going out <br/>books<br/>other bills <br/>events like Christmas and birthdays <br/>good place to start is by looking at average living costs for a student on the NUS website. There are also some good money management tips on the NUS finance pages. You’ll also find ‘top ten tips’ for better budgeting online.<br/>www.nus.org.uk/en/advice</p>
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"culture_two")}>Back</Button>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button style={{position:"absolute", right:"0px"}} onClick={this.onClick.bind(this,"money_two")}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
