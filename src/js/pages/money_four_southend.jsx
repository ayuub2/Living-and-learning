...
var MoneyPageFourSouthend = React.createClass({
    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <p>You can save large amounts of money when you shop in town and online by using the NUS Extra student discount card. This card is available to all students and offers amazing discounts on clothes, food, music, entertainment and travel from national and local companies including Amazon, Odeon, Pizza Express, Superdrug, ASOS, and Spotify. The sooner you apply the sooner you’ll start to save money!
          ...
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"money_three_southend_back")}>Back</Button>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button style={{position:"absolute", right:"0px"}} onClick={this.onClick.bind(this,"eat_southend")}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
...
module.exports = MoneyPageFourSouthend;
