    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/blue/arrow.jpg"/><a href="https://www.essexstudent.com/"> www.essex.su</a></p>
          <BasicSegment style={{height:"60px"}}>
            <Button onClick={this.onClick.bind(this,"culture_back")}>Back</Button>
