    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <p>Find Your Way is our interactive campus map app. Download it to help you find any location on campus and get directions quickly and easily. Trust us, you’ll need it! There’s also a handy web version.<br/><a href="http://findyourway.essex.ac.uk/"><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/> www.essex.ac.uk/welcome/findyourway</a></p>
