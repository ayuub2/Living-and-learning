...
var StudyPageSouthend = React.createClass({
    ...
    return (
      <Page >
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <p>The three schools at Southend Campus are Essex Business School, our School of Health and Human Sciences, and East 15 Acting School. The Centre of Psychoanalytic Studies is also based here. Each is responsible for teaching and research within a defined subject area, and there are also academic centres conducting teaching and research on a smaller scale.<br/><img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/><a href="http://www.essex.ac.uk/depts/"> www.essex.ac.uk/welcome/depts</a></p>
          ...
          <img height="10px" width="10px" src="http://www.essex.ac.uk/campusm/edits/icons/arrow.jpg"/><a href="http://www.essex.ac.uk/students/study-resources/tutor.aspx"> www.essex.ac.uk/welcome/tutor</a></p>
          <BasicSegment>
            <Button style={{position:"absolute", left:"45%", padding:"10px"}} circular onClick={this.onClick.bind(this,"content")}><i style={{margin:"auto",display:"block"}} className="grid layout icon"></i></Button>
            <Button onClick={this.onClick.bind(this,"study_two_southend")} style={{position:"absolute", right:"0px"}}>Next</Button>
          </BasicSegment>
        </BasicSegment>
      </Page>
    );
...
module.exports = StudyPageSouthend;
