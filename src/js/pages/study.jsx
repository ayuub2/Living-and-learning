    ...
    return (
      <Page>
        ...
        <BasicSegment style={{position:"absolute", width:"100%", top:"50px", height:"525px"}}>
          ...
          <p>We have 25 academic departments centres and schools, within three faculties – Humanities, Social Sciences, and Science and Health. Each is responsible for teaching and research within a defined subject area, and there are also academic centres conducting teaching and research on a smaller scale. www.essex.ac.uk/welcome/depts</p>
          <h2 style={{color:"#33ccff", fontWeight:"bold"}}>Personal tutors</h2>
          <p>As an undergraduate or taught postgraduate student you’ll have a personal tutor who you’ll meet soon after you arrive. If you’re a postgraduate research student your research supervisor will take on this role. Your personal tutor helps you connect with your department, school or centre; they’re someone you can talk to if you have questions about your course or encounter any difficulties that affect your studies. www.essex.ac.uk/welcome/tutor </p>
        </BasicSegment>
