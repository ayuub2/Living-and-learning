...
var ListviewItem = React.createClass({
  ...
  render:function() {
    ...
    if(label && !(thumbnail || icon)) {
      ...
      let labelProps = mergeProps({className:labelClass,children:label},this.props.labelProps);
    ...
    if(thumbnail || icon) {
      ...
      if(thumbnail) {
        thumb = thumbSize && (thumbSize !== "label") && <aek-img style={{backgroundImage:`url(${thumbnail})`}} /> || <img src={thumbnail}/>;
        ...
        var iconProps = mergeProps({className:icon + " icon"},props.iconProps);
        thumb = <i {...iconProps}/>;
      }
      content = (
...
var Listview = React.createClass({
  ...
  itemFactory:function(item,index) {
    ...
    ["basicLabel","labelVariation","labelEllipsis","labelRight","thumbnail","thumbSize","thumbContained","thumbBorder","thumbRounded","headingComponent"].forEach(function(prop) {
