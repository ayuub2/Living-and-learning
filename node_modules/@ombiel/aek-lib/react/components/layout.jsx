...
function getFlex(child) {
  var flex = child.props.flex == null && child.props.size == null && 1 || child.props.flex;
  if(flex === 0 && !child.key) {
...
var Layout = React.createClass({
  ...
  measure:function() {
    ...
    React.Children.forEach(this.props.children,function(child){
      ...
      if((!child.props.size && child.props.size !== 0) && flex === 0) {
        ...
        var domNode = this.refs[child.key].getDOMNode();
  ...
  render:function() {
    ...
    React.Children.forEach(this.props.children,function(child,index) {
      ...
      if(!child.key) {
        additionalProps.key = "_child" + index;
      }
      ...
      if(child.props.size) {
        ...
        if(child.key) {
          additionalProps.ref = child.ref || child.key;
          sze = this.state.measured[child.ref || child.key] || 0;
        }
      }
      ...
      children.push(cloneWithProps(child,additionalProps));
    }.bind(this));
